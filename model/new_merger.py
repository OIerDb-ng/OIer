...
sex = {"男":1,"女":-1,"":0}
contest_date = {"CSP提高":11/12.0,"CSP入门":11/12.0,"NOIP":11.6/12.0,"NOIP提高":11.5/12.0,"NOIP普及":11.5/12.0,"APIO":5.3/12.0,"CTSC":5.6/12.0,"NOI":7/12.0,"NOID类":7/12.0,"WC":1/12.0}
st = time.time()
school_id = {}
school_pos = {}
general = {'APIO': 4.5790, 'NOI': 4.7086, 'WC': 4.6628, 'CTSC': 4.6140, 'NOID类': 4.6678, 'NOIP提高': 4.6761, 'NOIP普及': 2.2134, 'CSP提高': 4.6761, 'CSP入门': 2.2134,'NOIP':4.6761}

sc = list(range(100,39,-1))+[i*0.01 for i in list(range(3600,750,-15))]+[i*0.01 for i in list(range(750,150,-3))]
sc_rt = {"NOI":1,"NOID类":0.75,"CTSC":0.2,"WC":0.5,"APIO":0.4,"NOIP提高":0.1,"NOIP普及":0.06,"CSP提高":0.1,"CSP入门":0.06,"NOIP":0.15}
